...
$status = ($course->getArchived()) ? "Archivado" : "Activo";
$lvlToSearch = "Intermedio";

$lvlFilter = array_filter($course->getLvls(), function ($level) use ($lvlToSearch) {
    ...
    <div class="max-w-4xl mx-auto space-y-12">
        ...
        <div class="minimal-card p-8 rounded-xl backdrop-blur-sm">
            ...
            <p class="text-gray-300 leading-relaxed mb-6">
                <span class="text-lime-400">// Descripción General:</span> <?= $course->getDescription() ?>
            </p>
            ...
            <div class="grid grid-cols-2 gap-6 text-sm">
                ...
                <div class="p-4 bg-gray-800/80 rounded-lg border border-cyan-700/50">
                    ...
                    <p class="text-3xl font-extrabold text-white">
                        <?= date("d/m/Y", strtotime($course->getPublicDate())) ?>
                    </p>
                </div>
            </div>
